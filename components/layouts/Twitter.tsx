...
// via https://adamwathan.me/2019/10/17/persistent-layout-patterns-in-nextjs/
const TwitterLayout = ({ children }: { children: ReactNode }) => {
  return (
...
export const getLayout = (page: any) => <TwitterLayout>{page}</TwitterLayout>;
