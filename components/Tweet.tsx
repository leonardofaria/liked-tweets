...
export default function Tweet({
  ...
  return (
    <div className="tweet border-t border-gray-300 dark:border-gray-800 p-4 w-full">
      <div className="flex">
        <a
        ...
        <div className="flex-grow ml-4">
          <header className="flex flex-wrap items-center">
            ...
            >
              ...
              <span className="ml-2 text-sm !text-gray-500" title={`@${author.username}`}>
                @{author.username}
              </span>
            </a>
            <a
          ...
          <div className="flex justify-between !text-gray-700 dark:!text-gray-300 mt-2 mr-16">
            <a
